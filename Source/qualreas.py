...
class SixPointNet(Network):
    """Create six Temporal Entities that represent time points and use them
    to express three independent intervals. For example, (s1,e1), (s2,e2),
    and (s3,e3), where s1 < e1, s2 < e2, and s3 < e3 represents three proper
    intervals.  Using '<|=' instead of '<', would represent three intervals
    where one or more might be points.  Return the network and the six
    temporal entities."""
